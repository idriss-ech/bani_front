...
export default function ProductsPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // setLoading(true); // Retirer le loading ici pour éviter le skeleton lors du filtrage
  ...
  useEffect(() => {
    ...
    result = result.filter(
      product => 
        (
          product.on_sale
            ? product.sale_price !== null && product.sale_price >= priceRange[0] && product.sale_price <= priceRange[1]
    ...
    <>
      ...
      <div className="bg-gradient-to-r from-red-500 to-red-700 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl">Découvrez notre vaste sélection de fournitures scolaires et livres</p>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="text-lg font-semibold mb-4 text-gray-800">Trier par</h3>
              <select
                value={sortOption}
