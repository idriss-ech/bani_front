        ...
        <div className="relative container mx-auto px-4 flex flex-col items-center justify-center">
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold drop-shadow-lg">Contactez-nous</h1>
            </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
              ...
              <div className="bg-white rounded-lg shadow-sm p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-800">Horaires d&apos;ouverture</h3>
                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                  <h3 className="font-medium text-gray-800 mb-3">Suivez-nous</h3>
                  <div className="flex space-x-4">
                    <a href="#" className="bg-gray-100 hover:bg-red-100 p-2 rounded-full transition-colors duration-200">
              ...
              <div className="bg-white rounded-lg shadow-sm p-8">
                ...
                {isSubmitted ? (
                  <div className="bg-green-50 border border-green-200 rounded-lg p-6 flex items-center">
                    ...
                    <div>
                      <h3 className="text-green-800 font-medium text-lg">Message envoyé avec succès!</h3>
                      <p className="text-green-700 mt-1">Merci de nous avoir contacté. Notre équipe vous répondra dans les meilleurs délais.</p>
                    </div>
                  </div>
                ) : (
          ...
          <div className="mt-12 bg-white rounded-lg shadow-sm overflow-hidden">
            <h2 className="text-2xl font-bold text-gray-800 p-8 pb-0">Notre emplacement</h2>
