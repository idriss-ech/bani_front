...
const StatsSection: React.FC = () => {
	...
	const easingFn = (t: number) => t < 0.5 ? 4 * t * t * t : (t - 1) * (2 * t - 2) * (2 * t - 2) + 1;
	...
	return (
        <section ref={sectionRef} className="bg-gradient-to-br from-red-600 via-red-500 to-red-500 py-16 px-4">
            <div className="max-w-7xl mx-auto">
            <div className={`text-center mb-10 transition-all duration-700 ease-out ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}>
                <h2 className="text-3xl md:text-4xl font-bold mb-3 text-white font-poppins tracking-wide">BANI en chiffres</h2>
                <p className="text-white/90 max-w-3xl mx-auto font-light">
                Des années d&rsquo;expérience et de service pour vous offrir le meilleur
                </p>
            </div>
