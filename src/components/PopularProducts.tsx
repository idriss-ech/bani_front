        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-gray-600 mt-4">
              Aucun produit populaire n&apos;est disponible actuellement.
    ...
    <section ref={sectionRef} className="py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div
          ...
          className={`flex flex-col md:flex-row justify-between items-center mb-10 transition-all duration-700 ease-out ${
        ...
        >
          ...
          <Link
            href="/products"
            className="mt-4 md:mt-0 px-6 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md font-medium transition-colors duration-300 flex items-center gap-2"
          >
            Voir tout
            <svg
              className="w-4 h-4"
