...
const services = [
  {
    ...
    description: "Service de commande sur mesure pour les écoles, entreprises et particuliers avec des besoins spécifiques.",
    icon: (
  ...
  },
  {
    ...
    description: "Envoyez-nous votre liste scolaire et récupérez un pack complet prêt à l'emploi pour la rentrée.",
    icon: (
      <svg className="w-10 h-10 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Service de livraison le jour même disponible dans Paris et sa petite couronne.",
    icon: (
      <svg className="w-10 h-10 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Service de personnalisation avec nom/prénom pour cartables, trousses et accessoires.",
    icon: (
      <svg className="w-10 h-10 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const ServicesSection: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 px-4 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className={`text-center mb-16 transition-all duration-700 ease-out ${
          ...
          <span className="text-red-600 uppercase tracking-wider font-medium text-sm mb-2 block">Services professionnels</span>
          <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-700">Nos services sur mesure</h2>
          <p className="text-gray-600 max-w-3xl mx-auto text-lg">
            BANI offre une gamme complète de services pour répondre à tous vos besoins en matière de fournitures scolaires et de bureau
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className={`lg:col-span-6 transition-all duration-700 ease-out ${
              ...
              {services.map((service) => (
                ...
                >
                  <div className="flex items-start">
                    <div className={`flex-shrink-0 mr-4 p-3 rounded-lg ${
                      activeService.id === service.id ? 'bg-red-50' : 'bg-gray-50'
                    } transition-colors duration-300`}>
                      {service.icon}
                    </div>
                    <div>
                      <h3 className={`text-xl font-semibold mb-2 transition-colors duration-300 ${
                        activeService.id === service.id ? 'text-red-600' : 'text-gray-800'
                      }`}>
                        {service.title}
                      </h3>
              ...
              {services.map((service) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 p-8">
                    <h4 className="text-white font-bold text-2xl mb-3 drop-shadow-md">{service.title}</h4>
